...
SubShader {
 Tags { "IGNOREPROJECTOR" = "False" "QUEUE" = "Geometry+100" "RenderType" = "Opaque" "SplatCount" = "16" }
 Pass {
  Name "FORWARD"
  Tags { "IGNOREPROJECTOR" = "False" "LIGHTMODE" = "FORWARDBASE" "QUEUE" = "Geometry+100" "RenderType" = "Opaque" "SHADOWSUPPORT" = "true" "SplatCount" = "16" }
  GpuProgramID 456
Program "vp" {
SubProgram "d3d11 " {
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "FORWARD"
  Tags { "IGNOREPROJECTOR" = "False" "LIGHTMODE" = "FORWARDADD" "QUEUE" = "Geometry+100" "RenderType" = "Opaque" "SHADOWSUPPORT" = "true" "SplatCount" = "16" }
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "DEFERRED"
  Tags { "IGNOREPROJECTOR" = "False" "LIGHTMODE" = "DEFERRED" "QUEUE" = "Geometry+100" "RenderType" = "Opaque" "SplatCount" = "16" }
  GpuProgramID 134182
Program "vp" {
SubProgram "d3d11 " {
"// shader disassembly not supported on DXBC"
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "ShadowCaster"
  Tags { "IGNOREPROJECTOR" = "False" "LIGHTMODE" = "SHADOWCASTER" "QUEUE" = "Geometry+100" "RenderType" = "Opaque" "SHADOWSUPPORT" = "true" "SplatCount" = "16" }
  GpuProgramID 214863
Program "vp" {
SubProgram "d3d11 " {
...
Fallback "Hidden/MicroSplat/Slice_2_3_Base503005416"
