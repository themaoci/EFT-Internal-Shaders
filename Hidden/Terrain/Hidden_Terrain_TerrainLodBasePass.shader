...
SubShader {
 Tags { "QUEUE" = "Geometry+102" "RenderType" = "Opaque" }
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE" = "FORWARDBASE" "QUEUE" = "Geometry+102" "RenderType" = "Opaque" "SHADOWSUPPORT" = "true" }
  GpuProgramID 37353
Program "vp" {
SubProgram "d3d11 " {
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE" = "FORWARDADD" "QUEUE" = "Geometry+102" "RenderType" = "Opaque" "SHADOWSUPPORT" = "true" }
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "DEFERRED"
  Tags { "LIGHTMODE" = "DEFERRED" "QUEUE" = "Geometry+102" "RenderType" = "Opaque" }
  GpuProgramID 188047
Program "vp" {
SubProgram "d3d11 " {
"// shader disassembly not supported on DXBC"
